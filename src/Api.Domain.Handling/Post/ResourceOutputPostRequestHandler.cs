...
{    public class ResourceOutputPostRequestHandler : IRequestHandler<ResourceOutputPostRequest, ResourceOutputResponse<Data.Model.Response.Resource>>
    {
        ...
        public ResourceOutputPostRequestHandler(
            IMapper mapper,
        ...
        public async Task<ResourceOutputResponse<Data.Model.Response.Resource>> Handle(ResourceOutputPostRequest request, CancellationToken cancellationToken)
        {
            var response = new ResourceOutputResponse<Data.Model.Response.Resource>();
